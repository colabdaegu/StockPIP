...
public class StockList {
    ...
    public StockList(String ticker, int toggleOption, double targetPrice, double stopPrice, int refreshMinute, int refreshSecond) {
        stockArray.add(new Stocks(ticker, toggleOption, targetPrice, stopPrice, refreshMinute, refreshSecond));
    }
